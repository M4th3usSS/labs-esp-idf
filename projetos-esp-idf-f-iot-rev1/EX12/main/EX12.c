...
#define EXAMPLE_ESP_WIFI_SSID 	"XT10406621"
#define EXAMPLE_ESP_WIFI_PASS 	"565f44581e24"
...
void Task_httpPOST ( void *pvParameter )
{
	...
	{	
		...
		const char * mesg_POST = \
					"POST /things/services/api/v1/variables/S00/?token=7f33f3ce94f774494feb8f1843511509 HTTP/1.1\n"
					"Host: www.geniot.io\n"
					"Content-Type: application/json\n"
					"Content-length: 11\n\n"
					"{\"value\":1}";
									
		req = (char*)malloc(strlen(mesg_POST)+1);
...
{	
	...
	*/
	...
	xTaskCreate( Task_httpPOST, "TaskHttpPost", 10000, NULL, 5, NULL );
}
